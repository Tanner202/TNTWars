...
public class Arena {
    ...
    public Arena(Minigames minigames, int id) {
        ...
        this.game = new Game(this, minigames);
        canJoin = true;
    }
    ...
    public void setKit(UUID uuid, KitType type) {
        ...
        if (type == KitType.BUILDER) {
            kits.put(uuid, new BuilderKit(minigames, uuid));
        } else if (type == KitType.LAST_CHANCE) {
            kits.put(uuid, new LastChanceKit(minigames, uuid));
        } else if (type == KitType.SNEAKY) {
            kits.put(uuid, new SneakyKit(minigames, uuid));
        } else if (type == KitType.DEFLECTOR) {
            kits.put(uuid, new DeflectorKit(minigames, uuid));
        } else if (type == KitType.BLINDER) {
            kits.put(uuid, new BlinderKit(minigames, uuid));
        } else if (type == KitType.FREEZER) {
            kits.put(uuid, new FreezerKit(minigames, uuid));
        }
    }
